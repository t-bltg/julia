...
void jl_init_types(void) JL_GC_DISABLED
{
    ...
    jl_datatype_type->name->n_uninitialized = 16 - 3;
    ...
    jl_typename_type->name->names = jl_perm_symsvec(13, "name", "module",
                                                    ...
                                                    "mt", "partial");
    jl_typename_type->types = jl_svec(13, jl_symbol_type, jl_any_type /*jl_module_type*/, jl_simplevector_type,
    ...
    *(size_t*)jl_an_empty_string = 0;
    ...
    jl_svecset(jl_typename_type->types, 7, jl_int32_type);
