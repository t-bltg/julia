...
void jl_init_types(void) JL_GC_DISABLED
{
    ...
    jl_typename_type->name->n_uninitialized = 11 - 2;
    jl_typename_type->name->names = jl_perm_symsvec(11, "name", "module",
                                                    "names", "wrapper",
                                                    "cache", "linearcache",
                                                    "mt", "partial",
                                                    "hash", "n_uninitialized",
                                                    "flags"); // "abstract", "mutable", "mayinlinealloc"
    jl_typename_type->types = jl_svec(11, jl_symbol_type, jl_any_type /*jl_module_type*/, jl_simplevector_type,
    ...
    *(size_t*)jl_an_empty_string = 0;
    ...
    jl_svecset(jl_typename_type->types, 8, jl_long_type);
    jl_svecset(jl_typename_type->types, 9, jl_int32_type);
    jl_svecset(jl_typename_type->types, 10, jl_uint8_type);
